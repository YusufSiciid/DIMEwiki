[1,"All stages"],
  ...
  [2,"Have you secured all approvals from MoHD and SCI/ ToR of support needed in your context?"],
  [2,"Has someone contacted the local leaders in the pilot area to inform them of planned survey activity?"],
  [2,"Will the team be staying overnight in the pilot area? If so, do you have necessary permissions to travel and stay overnight?"],
  [2,"Has someone taken care of the logistics (e.g. car rentals, meals or per diem for enumerators)?"],
  [2,"Do you have a venue reserved for training the interviewers?"],
[1,"Pre-Pilot"],
  [2,"Do you have a set protocol for identifying participants (inclusion and exclusion criteria?"],
...
[1,"Content-Focused Pilot"],
  [2,"Is the questionnaire you are piloting fully translated into the local language (Somali)?"],
...
[1,"Data-Focused Pilot"],
  ...
  [2,"Have you set up a Kobo/Commcare server for the pilot?"],
  ...
  [2,"Is the Kobo/Commcare Collect app updated to the version of your server?"],
    [3,"Best to update your server and app to the latest version before starting the pilot."],
  ...
  [2,"Are all tablets fully charged? Do you have battery packs/charger with you in case any batteries run out?"],
